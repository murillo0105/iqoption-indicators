instrument { name = "Pivot Points v1", icon="indicators:ADX", overlay = true }
...
input_group {
    ...
    level_0_width = input { default = 2, type = input.line_width }
}
...
input_group {
    ...
    level_3_width = input { default = 2, type = input.line_width }
}
